var Vue = (function (exports) {
    ...
    function trigger(target, type, key, newValue, oldValue, oldTarget) {
        debugger;
        console.warn("trigger", type, key, newValue, oldValue);
        ...
        if (type === "clear" /* CLEAR */) {
            ...
            console.error("key === 'length' && isArray(target)");
    ...
    function createSetter(shallow = false) {
        return function set(target, key, value, receiver) {
            console.info("set操作", "key:"+key, "value:"+value);
            ...
            if(isArray(target) && isIntegerKey(key)) {
                console.info("hadKey比较开始", "Number(key):"+Number(key), "原来的数组长度:"+target.length);
            } else {
                console.info("hadKey不比较，转而hasOwn", hasOwn(target, key));
            }
            ...
            if (target === toRaw(receiver)) {
                console.info("oldValue:"+oldValue, "newValue:"+value);
                if (!hadKey) {
