var Vue = (function (exports) {
    ...
    function get$1(target, key, isReadonly = false, isShallow = false) {
        ...
        console.warn("Proxy.get", rawKey);
        if (key !== rawKey) {
            console.error("Proxy.get key !== rawKey", target, rawTarget, rawKey);
        ...
        if (has.call(rawTarget, key)) {
            console.info("has.call(rawTarget, key)");
            return wrap(target.get(key));
        }
        else if (has.call(rawTarget, rawKey)) {
            console.info("has.call(rawTarget, rawKey)");
